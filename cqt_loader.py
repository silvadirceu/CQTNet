...
class CQT(Dataset):
    def __init__(self, mode='train', out_length=None):
        ...
        self.indir = 'data/setlist_h5/'
        
        self.mode=mode
        
        if mode == 'train': 
            filepath='data/setlist_train'
        elif mode == 'val':
            filepath='data/setlist_val'
        elif mode == 'test': 
            filepath='data/setlist_test'
    ...
    def __getitem__(self, index):
        ...
        in_path = self.indir+filename+'.h5'
        data = dd.load(in_path) # from 12xN to Nx12
